...
setupSelection('npm');
// This webpack has a really annoying error, if I don't call the function once in this js file:
// error  'setupSelection' is defined but never used  no-unused-vars

function submitCallback(param) {
	if (param !== 'npm') {
		const showList = ['occation',
			'fashion',
			'feeling',
...
submitCallback('npm');
// This webpack has a really annoying error, if I don't call the function once in this js file:
// error  'submitCallback' is defined but never used  no-unused-vars
